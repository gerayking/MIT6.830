...
public class Join extends Operator {
    ...
    public void open() throws DbException, NoSuchElementException,
        ...
        while (child1.hasNext()){
            final Tuple next1 = child1.next();
            while(child2.hasNext()){
                final Tuple next2 = child2.next();
                if(p.filter(next1,next2)){
                    final Iterator<Field> fields1 = next1.fields();
                    final Iterator<Field> fields2 = next2.fields();
                    int tmp = 0;
                    final Tuple tuple = new Tuple(tupleDesc);
                    while(fields1.hasNext()){
                        tuple.setField(tmp,fields1.next());
                        tmp++;
                    }
                    while(fields2.hasNext()){
                        tuple.setField(tmp,fields2.next());
                        tmp++;
                    }
                    list.add(tuple);
                }
